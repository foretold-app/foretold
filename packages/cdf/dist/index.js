parcelRequire = function(e, r, t, n) {
    ...
    "4HJa": [function(require, module, exports) {
        var global = arguments[3];
        ...
        (function() {
            ...
            var Sr = function n(t) {
                var Jn, Yn = (t = null == t ? St : Sr.defaults(St.Object(), t, Sr.pick(St, xt))).Array,
                    Qn = t.Date,
                    Xn = t.Error,
                    nt = t.Function,
                    tt = t.Math,
                ...
                function Je(n, t) {
                    for (var e = 0, u = (t = Ku(t, n)).length; null != n && e < u;) n = n[co(t[e++])];
                    return e && e == u ? n : r
                }
                ...
                function yu(n, t, r) {
                    var e = -1;
                    return t = Yt(t.length ? t : [Sa], vr(Bi())),
                        function(n, t) {
                            var r = n.length;
                ...
                function di(n) {
                    return function(t, e, u) {
                        return u && "number" != typeof u && Ki(t, e, u) && (e = u = r), t = Ff(t), e === r ? (e = t, t = 0) : e = Ff(e),
                            function(n, t, r, e) {
                ...
                function Gi(n) {
                    ...
                    var e = Li(r);
                    return !!e && n === e[0]
                }(Yr && Fi(new Yr(new ArrayBuffer(1))) != fn || Qr && Fi(new Qr) != V || Xr && "[object Promise]" != Fi(Xr.resolve()) || ne && Fi(new ne) != X || te && Fi(new te) != en) && (Fi = function(n) {
                    var t = Qe(n),
                ...
                function Xi(n, t, e) {
                    return t = Zr(t === r ? n.length - 1 : t, 0),
                        function() {
                            for (var r = arguments, u = -1, i = Zr(r.length - t, 0), o = Yn(i); ++u < i;) o[u] = r[t + u];
                            u = -1;
                ...
                return pe.after = function(n, t) {
                    ...
                    var u = null == n ? 0 : n.length;
                    if (!u || t < 1) return [];
                    for (var i = 0, o = 0, f = Yn($r(u / t)); i < u;) f[o++] = zu(n, i, i += t);
                    return f
                    ...
                    var i, o, f = Hf({}, t.imports, u.imports, ki),
                        a = ia(f),
                        c = _r(f, a),
                        l = 0,
                        s = t.interpolate || Gn,
            ...
            "function" == typeof n && "object" == typeof n.amd && n.amd ? (St._ = Sr, n(function() {
                return Sr
    ...
    "PukG": [function(require, module, exports) {
        function r(r, n, t, e, u) {
            return t * ((n - u) / (n - r)) + e * ((u - r) / (n - r))
        }

        function n(r, n, t) {
            if (t <= 0) throw new RangeError("n is less then zero");
            if (t === 1 / 0) throw new RangeError("n is Infinity");
            if (0 === t) return [];
            if (1 === t) return [r];
            if (2 === t) return [r, n];
            if (r === n) return Array(t).fill(r);
            t -= 1;
            var e = r - n,
                u = Math.abs(e / t),
                o = [],
            ...
            return t + 1 - o.length == 1 && o.push(n), o
        }
    ...
    "GgZf": [function(require, module, exports) {
        function t(t, n) {
        ...
        var i = require("lodash"),
            ...
            o = function() {
                function n(e, r) {
                    if (t(this, n), !i.isArray(e)) throw new Error("XS should be an array.");
                    if (!i.isArray(r)) throw new Error("YS should be an array.");
                    if (!this.validateHasLength(e)) throw new Error("You need at least one element.");
                    if (!this.validateSize(e, r)) throw new Error('Arrays of "xs" and "ys" have different sizes.');
                    var s = this.order(e, r);
                    this.xs = s.xs, this.ys = s.ys
                }
                return e(n, [{
                    key: "order",
                    value: function(t, n) {
                        var e = t.map(function(t, e) {
                            ...
                            return t.xs > n.xs ? 1 : t.xs < n.xs ? -1 : 0
                        });
                        return {
                            xs: e.map(function(t) {
                                return t.xs
                    ...
                    key: "findY",
                    value: function(t) {
                        var n = this.xs.findIndex(function(n) {
                            return n >= t
                        });
                        if (n < 0) return this.ys[this.ys.length - 1];
                        if (0 === n) return this.ys[0];
                        var e = n - 1;
                        return e < 0 && (e = 0), this.xs[e] !== t ? s(this.xs[e], this.xs[n], this.ys[e], this.ys[n], t) : this.ys[e]
                    }
                }, {
                    key: "findX",
                    value: function(t) {
                        var n = this.ys.findIndex(function(n) {
                            return n >= t
                        });
                        if (n < 0) return this.xs[this.xs.length - 1];
                        if (0 === n) return this.xs[0];
                        var e = n - 1;
                        return e < 0 && (e = 0), this.ys[e] !== t ? s(this.ys[e], this.ys[n], this.xs[e], this.xs[n], t) : this.xs[e]
                    }
                }, {
                    key: "convertWithAlternativeXs",
                    value: function(t) {
                        var e = this,
                            i = t.map(function(t) {
                                return e.findY(t)
                    ...
                    key: "convertToNewLength",
                    value: function(t) {
                        var n = u(a(this.xs), h(this.xs), t);
                        return this.convertWithAlternativeXs(n)
                    }
                }, {
                    key: "sampleSingle",
                    value: function() {
                    ...
                    value: function() {
                        ...
                        if (!(arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {
                                filterOutNaNs: !1
                            }).filterOutNaNs && i.includes(this.ys, NaN)) return NaN;
                        if (i.includes(this.ys, 1 / 0) && i.includes(this.ys, -1 / 0)) return NaN;
                        if (i.includes(this.ys, 1 / 0)) return 1 / 0;
                        if (i.includes(this.ys, -1 / 0)) return -1 / 0;
                        for (var n = 1; n < this.ys.length; n++) {
                            var e = this.ys[n],
                                r = this.ys[n - 1],
                                s = this.xs[n],
                                u = this.xs[n - 1];
                            if (i.isFinite(e) && i.isFinite(r) && i.isFinite(s) && i.isFinite(u)) t += (e + r) / 2 * (s - u)
                        }
                        return t
                    }
                }]), n
        ...
        module.exports = {
            ContinuousDistribution: o
        };
    }, {
        "lodash": "4HJa",
        "./functions": "PukG"
    }],
    "LAB0": [function(require, module, exports) {
        function n(n, e) {
            return r(n) || i(n, e) || t()
        }
        ...
        function i(n, t) {
            if (Symbol.iterator in Object(n) || "[object Arguments]" === Object.prototype.toString.call(n)) {
                var i = [],
                    ...
                    u = void 0;
                try {
                    for (var o, a = n[Symbol.iterator](); !(r = (o = a.next()).done) && (i.push(o.value), !t || i.length !== t); r = !0);
                } catch (s) {
                    e = !0, u = s
                } finally {
                    try {
        ...
        var a = require("lodash"),
            ...
            f = s.max,
            m = s.mean,
            b = require("./continuousDistribution"),
            y = b.ContinuousDistribution,
            h = function() {
                function t(n) {
                    e(this, t), this.distributions = n
                }
                return o(t, [{
                    key: "minX",
                    value: function() {
                        return c(this.distributions.map(function(n) {
                            return n.minX()
                        }))
                    }
                }, {
                    key: "maxX",
                    value: function() {
                        return f(this.distributions.map(function(n) {
                            return n.maxX()
                        }))
                    }
                }, {
                    key: "allYsAtXPoint",
                    value: function(n) {
                        return this.distributions.map(function(t) {
                            return t.findY(n)
                        })
                    }
                }, {
                    key: "equallyDividedXs",
                    value: function(n) {
                        return l(this.minX(), this.maxX(), n)
                    }
                }, {
                    key: "combineYsWithFn",
                    value: function(t, i) {
                        var r = this,
                            e = this.equallyDividedXs(t),
                            u = e.map(function(n) {
                                return i(r.allYsAtXPoint(n))
                            }),
                            o = a.filter(a.zip(e, u), function(n) {
                                return a.isNumber(n[1])
                            }),
                            s = n(a.unzip(o), 2),
                            l = s[0],
                            c = s[1];
                    ...
                    key: "combineYsWithMean",
                    value: function(n) {
                        return this.combineYsWithFn(n, m)
                    }
                }]), t
            }();
        module.exports = {
            ContinuousDistributionCombination: h
        };
    }, {
        "lodash": "4HJa",
        "./functions": "PukG",
        "./continuousDistribution": "GgZf"
    }],
    "GLEa": [function(require, module, exports) {
        function t(e) {
        ...
        var s = require("lodash"),
            y = require("./cdf"),
            l = y.Cdf,
            p = require("./continuousDistribution"),
            a = p.ContinuousDistribution,
            b = function(t) {
                function n() {
                    return e(this, n), r(this, u(n).apply(this, arguments))
                }
                return f(n, a), o(n, [{
                    key: "toCdf",
                    value: function() {
                        for (var t = [s.isFinite(this.ys[0]) ? this.ys[0] : 0], e = 1; e < this.ys.length; e++) {
                            var n = s.isFinite(this.ys[e]) ? t[e - 1] + this.ys[e] : t[e - 1];
                            t.push(n)
                        }
                        return new l(this.xs, t)
                    }
                }]), n
            }();
        module.exports = {
    ...
    "wl5O": [function(require, module, exports) {
        function t(n) {
            return (t = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
                return typeof t
            } : function(t) {
        ...
        function r(n, e) {
            return !e || "object" !== t(e) && "function" != typeof e ? i(n) : e
        }
        ...
        var c = require("./continuousDistribution"),
            a = c.ContinuousDistribution,
            l = require("./continuousDistributionCombination"),
            y = l.ContinuousDistributionCombination,
            p = function(t) {
                function e() {
                    return n(this, e), r(this, u(e).apply(this, arguments))
                }
                return f(e, a), o(e, [{
                    key: "toPdf",
                    value: function() {
                        for (var t = [this.ys[0]], n = 1; n < this.ys.length; n++) t.push((this.ys[n] - this.ys[n - 1]) / (this.xs[n] - this.xs[n - 1]));
                        return new(require("./pdf").Pdf)(this.xs, t)
                    }
                }, {
                    key: "toUniform",
                    value: function(t) {
                        return e.createUniform({
                            min: this.xs[0],
                    ...
                    value: function(t) {
                        var n = t.cdf,
                            ...
                            u = new y([this, i]),
                            f = 1 / (1 + o),
                            s = u.combineYsWithFn(r, function(t) {
                                return (t[0] + t[1] * o) * f
                            });
                        return new e(s.xs, s.ys)
                    }
                }], [{
                    key: "createUniform",
                    value: function(t) {
                        var n = t.min,
                            ...
                            r = t.sampleCount,
                            i = function(t) {
                                return t.splice(0, 2).concat(t[t.length - 1])
                            },
                            u = new e([n, o], [0, 1]).convertToNewLength(r);
                        return new e(i(u.xs), i(u.ys))
                    }
                }]), e
            }();
        module.exports = {
        ...
        "./continuousDistribution": "GgZf",
        "./continuousDistributionCombination": "LAB0",
        "./pdf": "GLEa"
    }],
    "pgRh": [function(require, module, exports) {
        "use strict";
        var n = module.exports;
        module.exports.isNumber = function(n) {
            return "number" == typeof n
        }, module.exports.findMin = function(n) {
            if (0 === n.length) return 1 / 0;
            for (var t = n[0], r = 1; r < n.length; r++) t = Math.min(t, n[r]);
            return t
        }, module.exports.findMax = function(n) {
            if (0 === n.length) return -1 / 0;
            for (var t = n[0], r = 1; r < n.length; r++) t = Math.max(t, n[r]);
            return t
        }, module.exports.findMinMulti = function(t) {
            for (var r = n.findMin(t[0]), e = 1; e < t.length; e++) r = Math.min(r, n.findMin(t[e]));
            return r
        }, module.exports.findMaxMulti = function(t) {
            for (var r = n.findMax(t[0]), e = 1; e < t.length; e++) r = Math.max(r, n.findMax(t[e]));
            return r
        }, module.exports.inside = function(n, t, r) {
            return n <= r && r <= t
        };
    }, {}],
    "Jd6/": [function(require, module, exports) {
        "use strict";
        var i = 50,
            e = 2,
            t = Math.log(2),
        ...
        function a(i, e) {
            for (var t = {}, n = 0, r = -e; r <= e; r++) n += i(r / e), t[r] = n;
            return t
        }
        module.exports.getUnifiedMinMax = function(i, e) {
            return n.getUnifiedMinMaxMulti([i], e)
        }, module.exports.getUnifiedMinMaxMulti = function(t, n) {
            n = n || {};
            var u = !1,
                a = !1,
                o = r.isNumber(n.width) ? n.width : e,
                f = r.isNumber(n.size) ? n.size : i,
                h = r.isNumber(n.min) ? n.min : (u = !0, r.findMinMulti(t)),
                m = r.isNumber(n.max) ? n.max : (a = !0, r.findMaxMulti(t)),
                l = (m - h) / (f - 1);
            return u && (h -= 2 * o * l), a && (m += 2 * o * l), {
                min: h,
                max: m
            }
        }, module.exports.create = function(t, o) {
            if (o = o || {}, !t || 0 === t.length) return [];
            var f = r.isNumber(o.size) ? o.size : i,
                h = r.isNumber(o.width) ? o.width : e,
                m = n.getUnifiedMinMax(t, {
                    size: f,
                    width: h,
                    min: o.min,
                    max: o.max
            ...
            t.forEach(function(i) {
                var e = function(i) {
                    return Math.floor((i - l) / x)
                }(i);
                if (!(e + h < 0 || e - h >= d.length)) {
                    var t = Math.max(e - h, 0),
                        n = e,
                        u = Math.min(e + h, d.length - 1),
                        a = t - (e - h),
                        o = e + h - u,
                        f = M[-h - 1 + a] || 0,
                        m = M[-h - 1 + o] || 0,
                        s = g / (g - f - m);
                    a > 0 && (y += s * (a - 1) * v);
                    var c = Math.max(0, e - h + 1);
                    r.inside(0, d.length - 1, c) && (d[c].y += 1 * s * v), r.inside(0, d.length - 1, n + 1) && (d[n + 1].y -= 2 * s * v), r.inside(0, d.length - 1, u + 1) && (d[u + 1].y += 1 * s * v)
                }
            });
            var p = y,
                b = 0,
            ...
            return d.forEach(function(i) {
                b += i.y, p += b, i.y = p, w += p
            }), w > 0 && d.forEach(function(i) {
                i.y /= w
            }), d
        }, module.exports.getExpectedValueFromPdf = function(i) {
            if (i && 0 !== i.length) {
                var e = 0;
        ...
        }, module.exports.getXWithLeftTailArea = function(i, e) {
            if (i && 0 !== i.length) {
                for (var t = 0, n = 0, r = 0; r < i.length && (n = r, !((t += i[r].y) >= e)); r++);
                return i[n].x
            }
        }, module.exports.getPerplexity = function(i) {
            if (i && 0 !== i.length) {
                var e = 0;
                return i.forEach(function(i) {
                    var t = Math.log(i.y);
    ...
    "NkpK": [function(require, module, exports) {
        function t(t, n, r) {
            if (t[n] === t[r]) return -1;
            for (; n !== r - 1;) {
                var e = Math.floor((r + n) / 2);
                t[n] === t[e] ? n = e : r = e
            }
            return r
        }
        ...
        function n(n) {
            ...
            for (var e = 0, u = 0; - 1 !== u && (e++, u = t(n, u, n.length), !(e >= r)););
            return e
        }

        function r(t) {
            return Object.assign([], t).sort(function(t, n) {
                return t - n
            })
        }
        ...
        function e(t) {
            ...
            return {
                mean: e,
                stdev: Math.sqrt(u - Math.pow(e, 2))
            }
        }

        function u(t, n, r) {
            return t[Math.floor(n * (r / 100))]
        }

        function o(t, n) {
            var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
                e = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : t.length;
            if (t[e - 1] <= n) return -1;
            for (; r !== e - 1;) {
                var u = Math.floor((e + r) / 2);
                t[u] <= n ? r = u : e = u
            }
            return e
        }
        module.exports = {
            numDistinctValues: n,
            sortDescending: r,
            sampleMeanAndStdev: e,
            percentile: u,
            cutoff: o
        };
    }, {}],
    "oss4": [function(require, module, exports) {
        function e(e, t) {
        ...
        var n = require("pdfast"),
            r = require("./dataAnalysis"),
            s = r.percentile,
            a = r.sortDescending,
            o = require("./pdf"),
            u = o.Pdf,
            ...
            f = function() {
                function t(i) {
                    e(this, t), this.samples = i, this.sorted = []
                }
                return i(t, [{
                    key: "sort",
                    value: function() {
                        this.sorted = a(this.samples)
                    }
                }, {
                    key: "getPercentile",
                    value: function(e) {
                        var t = this.sorted.length;
                        return 0 === t && console.error("Samples Percentile: You must sort samples before finding the percentile."), s(this.sorted, t, e)
                    }
                }, {
                    key: "filter",
                    value: function(e) {
                        var i = e.max,
                            n = e.min,
                            r = this.samples;
                        return l.isFinite(n) && (r = l.filter(r, function(e) {
                            return e > n
                        })), l.isFinite(i) && (r = l.filter(r, function(e) {
                            return e < i
                        })), new t(r)
                    }
                }, {
                    ...
                    value: function(e) {
                        ...
                        l.isFinite(t) && (n.min = t), l.isFinite(i) && (n.max = i);
                        var r = this._kde(n);
                        return new u(r.map(function(e) {
                            return e.x
                        }), r.map(function(e) {
                            return e.y
                        }))
    ...
    "xIS+": [function(require, module, exports) {
        var t = require("./continuousDistributionCombination"),
            n = t.ContinuousDistributionCombination,
            i = require("lodash"),
            o = function(t) {
                var n = t.prediction,
                    i = t.aggregate;
                return Math.log2(n / i)
            },
            r = function(t) {
                var n = t.prediction,
                    i = t.aggregate,
        ...
        function e(t) {
            var i = t.predictionCdf,
                ...
                d = o.toPdf(),
                c = e.toPdf();
            return new n([s, d, c]).combineYsWithFn(a, function(t) {
                return r({
                    prediction: t[0],
                    aggregate: t[1],
                    result: t[2]
        ...
        function u(t) {
            var i = t.predictionCdf,
                ...
                u = i.toPdf(),
                a = o.toPdf();
            return new n([u, a]).combineYsWithFn(e, function(t) {
                return 0 === t[1] ? 0 : t[1] * Math.log2(Math.abs(t[0] / t[1]))
            })
        }
        ...
        function a(t) {
            var i = t.cdf,
                ...
                r = void 0 === o ? 1e4 : o,
                e = i.toPdf();
            return new n([e]).combineYsWithFn(r, function(t) {
                return t[0] * Math.log2(t[0])
            })
        }
        var s = {
            distributionInputDistributionOutputMarketless: u,
            distributionInputDistributionOutput: e,
            scoreFunctionWithoutResult: o,
            scoreFunctionWithResult: r,
            differentialEntropy: a
        };
        module.exports = {
            scoringFunctions: s
        };
    ...
    "Focm": [function(require, module, exports) {
        var i = require("./lib/cdf"),
            n = i.Cdf,
            o = require("./lib/pdf"),
            u = o.Pdf,
            t = require("./lib/samples"),
            r = t.Samples,
            s = require("./lib/continuousDistributionCombination"),
            e = s.ContinuousDistributionCombination,
            b = require("./lib/continuousDistribution"),
            l = b.ContinuousDistribution,
            C = require("./lib/scoring"),
            c = C.scoringFunctions;
        module.exports = {
            Pdf: u,
            Cdf: n,
            Samples: r,
            ContinuousDistribution: l,
            ContinuousDistributionCombination: e,
            scoringFunctions: c
        };
    }, {
        "./lib/cdf": "wl5O",
        "./lib/pdf": "GLEa",
        "./lib/samples": "oss4",
        "./lib/continuousDistributionCombination": "LAB0",
        "./lib/continuousDistribution": "GgZf",
        "./lib/scoring": "xIS+"
    }]
}, {}, ["Focm"], null)