...
const MeasurementValueI_make = function (Arg1) {
  const result = JsInterfaceBS.MeasurementValueI[0](Arg1);
  return {data:result[0], error:result[1]}
};;
...
const PredictionResolutionGroupI_pointScore = JsInterfaceBS.PredictionResolutionGroupI[1];;
...
const PredictionResolutionOverTimeI_pointScoreIntegral = JsInterfaceBS.PredictionResolutionOverTimeI[3];;
