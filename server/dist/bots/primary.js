...
let evaluate = function (vs) {
  ...
  return {
    ...
    data: {
      "25.": _lodash2.default.mean(foo.map(e => e.value.data["25."])) * 0.7,
      "50.": _lodash2.default.mean(foo.map(e => e.value.data["50."])),
      "75.": _lodash2.default.mean(foo.map(e => e.value.data["75."])) * 1.3
    }
  };
};
