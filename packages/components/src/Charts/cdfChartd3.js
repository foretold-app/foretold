...
function chart() {
    ...
    var main = function () {
        ...
        //Add hover text
        var hoverText = container.patternify({ tag: 'div', selector: 'hover-text' })
        
        var hoverTextY = hoverText.patternify({ tag: 'div', selector: 'hover-text-y' })
        var hoverTextX = hoverText.patternify({ tag: 'div', selector: 'hover-text-x' })
